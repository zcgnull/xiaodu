...
public class DeviceContentPageNewApi implements IRequestApi, IRequestServer {

    @NonNull
    @Override
    public String getApi() {
        return "api/jkgl/jkgl/xiaodu/queryDataRecordByBinderIdPage";
    }
    ...
    public DeviceContentPageNewApi(long binderId, String dataTypeCode, String beginDate, String endDate, Integer pageNo, Integer pageSize) {
